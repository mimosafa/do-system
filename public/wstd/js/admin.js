...
__webpack_require__(/*! ./includes/gallery */ "./resources/wstd/js/includes/gallery.js");

__webpack_require__(/*! ./includes/healthCenterSelect */ "./resources/wstd/js/includes/healthCenterSelect.js");
...
__webpack_require__(/*! ./includes/sortableTable */ "./resources/wstd/js/includes/sortableTable.js");

__webpack_require__(/*! ./includes/tabs */ "./resources/wstd/js/includes/tabs.js");

/***/ }),

/***/ "./resources/wstd/js/includes/gallery.js":
/*!***********************************************!*\
  !*** ./resources/wstd/js/includes/gallery.js ***!
  \***********************************************/
/*! no exports provided */
...
/***/ "./resources/wstd/js/includes/healthCenterSelect.js":
/*!**********************************************************!*\
  !*** ./resources/wstd/js/includes/healthCenterSelect.js ***!
  \**********************************************************/
/*! no static exports found */
...
var ep = location.origin + '/api/health-centers';
var forms = document.getElementsByTagName('form');

var initHealthCenterSelect = function initHealthCenterSelect(selectHealthCenter, prefectureId) {
  ...
  if (prefectureId > 0) {
    axios.get(ep + '?prefecture_id=' + prefectureId).then(function (response) {
...
try {
  var _loop = function _loop() {
    ...
    var selectPrefecture = form.querySelector('select.select-prefecture');
    var selectHealthCenter = form.querySelector('select.select-health-center');

    if (selectPrefecture && selectHealthCenter) {
      var prefectureId = selectPrefecture.value;
      ...
      selectPrefecture.addEventListener('change', function (e) {
...
/***/ "./resources/wstd/js/includes/sortableTable.js":
/*!*****************************************************!*\
  !*** ./resources/wstd/js/includes/sortableTable.js ***!
  \*****************************************************/
/*! no exports provided */
...
try {
  var _loop = function _loop() {
    ...
    var toggleOrSubmit = table.parentNode.getElementsByClassName('toggle-or-submit')[0];

    toggleOrSubmit.initToggle = function () {
      var exchangeText = toggleOrSubmit.dataset.exchangetext;
      toggleOrSubmit.innerHTML = '<b>' + exchangeText + '</b>';
      toggleOrSubmit.type = 'button';
      toggleOrSubmit.dataset.toggle = 'modal';
    };

    toggleOrSubmit.initSubmit = function () {
      var sortText = toggleOrSubmit.dataset.sorttext;
